...
ordered_columns = ['item_id', 'title', 'genres', 'director', 'producer', 'actors', 'release_date', 'release_month', 'country', 'duration', 'age_rating', 'imdb_rating', 'imdb_num_reviews', 'n_ratings', 'description', 'n_ratings_kid', 'n_ratings_teenager', 'n_ratings_young_adult', 'n_ratings_adult', 'n_ratings_senior', 'n_ratings_male', 'n_ratings_female', 'genres_list', 'directors_list', 'producers_list', 'actors_list']
